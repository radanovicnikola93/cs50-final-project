...
function getWeather(){
    ...
    if(search != ''){
        ...
        $.ajax({
            ...
            url: 'http://api.openweathermap.org/data/2.5/weather?q=' + search + "&units=metric" + "&APPID=e8f4a198e35c9c4649ccbf95c524b37f",
            type: "GET",
            dataType: "jsonp",
        ...
        $.ajax({
            url: 'http://api.openweathermap.org/data/2.5/forecast?q=' + search + "&units=metric" + "&APPID=c10bb3bd22f90d636baa008b1529ee25",
            type: "GET",
            dataType: "jsonp",
